...
path_texts_intro_server <-
  "//path/to/your/server/texts_intro" # replace with yours - not used in demo



## . authors ----
authors_text <-
  "Camille Velarde Crézé, Olivier Duperrex - Unisanté" # replace with yours

## . email_tester ---------------------------------------------------
email_tester <- c('participant_27@some.email',
                  'tester_2@some.email')
...
heading_toc <-
  "Table of content {#toc}"  ## the #toc will provide links
# heading_list_tables <- "Results tables"

heading_participants_characteristics <-
...
email_recipient_text <-
  "Individualised report for: " # used in individual reports
...
footnote_agreement_column_type1 <-
  paste0(
    ...
    "  = agreement reached (median ≥ ",
    agreement_threshold_type1,
    ")  ; ",
    icon_disagreement_reached,
    " = disagreement reached (median ≤ ",
...
footnote_consensus_column <-
  paste0(" Consensus reached (IQR ≤ ", consensus_threshold_type1, ")")
...
no_op_long  <-
  "I do not want or do not wish to answer this question."
...
other_please_long  <-
  "Other \\(please specify your answer in the comment below\\)"
...
title_overall <-
  "Templates REDCap : are they working?"  # for overall executive summary
